...
7. **Ролевая система**: разграничение прав для заведующего и кассира
...
1. **CustomUser** - пользователи с ролями (manager, cashier)
...
- **manager / manager123** - полный доступ
